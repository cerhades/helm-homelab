...
*/}}
{{- define "common-library.classes.service" -}}
...
{{- $serviceName := include "common-library.names.fullname" . -}}
{{- if and (hasKey $values "nameOverride") $values.nameOverride -}}
  {{- $serviceName = printf "%v-%v" $serviceName $values.nameOverride -}}
{{ end -}}
{{- $svcType := $values.type | default "" -}}
{{- $primaryPort := get $values.ports (include "common-library.classes.service.ports.primary" (dict "values" $values)) }}
---
apiVersion: v1
kind: Service
metadata:
...
spec:
  ...
  {{- end }}
  selector:
    {{- include "common-library.labels.selectorLabels" . | nindent 4 }}
{{- end }}